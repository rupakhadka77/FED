...
<body>
    ...
    <div class="bg-contact2" style="background-image: url('img/black-bg.jpg');">
        <div class="container-contact2">
            <div class="wrap-contact2" style="margin-top:100px;">
                <form class="contact2-form" method="post" action="includes/create-poll.inc.php">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="input_fields_wrap">
                            <button class="add_field_button btn btn-dark">Add More Fields</button>
                    ...
                    <div class="text-center">
                        <br><br><a class="btn btn-dark btn-lg btn-block" href="polls.php">
                            View Polls</a>
                    </div>
