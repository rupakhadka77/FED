...
-- Database: `fed_database`

--

create DATABASE fed_database;
...
VALUES (
        ...
        '2018-12-09',
        0,
        'This blog also contains some random content but in more quantity.'
    ), (
        4,
        'Third Blog',
        'default.png',
        ...
        '2018-12-09',
        0,
        'Sorry for boring you with random stuff.'
    ), (
        6,
        'Fourth Blog',
        'default.png',
        ...
        '2018-12-09',
        0,
        'Seriously, you wasted time by visiting this blog.'
    ), (
        8,
        'aaaaaa',
        'default.png',
        ...
        '2018-12-23',
        1,
        'gimme some of that milk boii'
    ), (
        14,
        'Kill him?',
        '5c20807b0024e5.50196869.jpg',
        36,
        '2018-12-24',
        2,
        'Your votes wont make a difference. He\'s gonna die anyway'
    ), (
        15,
        'Staying Healthy',
        'blog-cover.png',
        ...
        19,
        'The Impact of Fiction in our Evolution',
        'blog-cover.png',
        37,
        '2018-12-24',
        3,
...
VALUES (6, 12, 24, '2018-12-21', 1), (7, 13, 24, '2018-12-23', 1), (8, 15, 35, '2018-12-24', 1), (9, 17, 24, '2018-12-24', 1), (10, 16, 24, '2018-12-24', 1), (11, 16, 37, '2018-12-24', 1), (12, 16, 35, '2018-12-24', 1), (13, 2, 37, '2018-12-24', 1), (14, 14, 36, '2018-12-24', 1), (15, 19, 37, '2018-12-24', 1), (17, 16, 36, '2018-12-24', 1), (18, 16, 25, '2018-12-24', 1), (21, 14, 24, '2018-12-26', 1), (22, 19, 24, '2018-12-27', 1), (23, 19, 39, '2018-12-28', 1);
...
CREATE TRIGGER `CALC_BLOG_VOTES_AFTER_DELETE` AFTER 
DELETE ON `BLOGVOTES` FOR EACH ROW BEGIN 
	update blogs
	set
	    blogs.blog_votes = blogs.blog_votes - old.vote
	where
	    blogs.blog_id = old.voteBlog;
	END 
$ 
...
CREATE TRIGGER `CALC_BLOG_VOTES_AFTER_INSERT` AFTER 
INSERT ON `BLOGVOTES` FOR EACH ROW BEGIN 
	update blogs
	set
	    blogs.blog_votes = blogs.blog_votes + new.vote
	where
	    blogs.blog_id = new.voteBlog;
	END 
$ 
...
CREATE TRIGGER `CALC_BLOG_VOTES_AFTER_UPDATE` AFTER 
UPDATE ON `BLOGVOTES` FOR EACH ROW BEGIN 
	update blogs
	set
	    blogs.blog_votes = blogs.blog_votes + (new.vote * 2)
	where
	    blogs.blog_id = new.voteBlog;
	END 
$ 
...
VALUES (
        4,
        'finance sciences',
        'all topics related to finance and economy like making double decker chocolate cake and how to end the world in 3 days'
    ), (
        5,
        'gardening',
        'different gardening techniques used to torture helpless victims and make them dream of attending horrible opera performances'
    ), (8, 'sad', 'sadsadsadsad'), (
        9,
        'Technical Difficulties',
        'Issues and debates related to immediate actions which must be taken on event of a serious butthurt'
    ), (13, 'aaa', 'aaaaaaa');
...
INSERT INTO
    `conversation` (`id`, `user_one`, `user_two`)
VALUES (15, 24, 30), (16, 24, 25), (17, 25, 30), (18, 24, 26), (19, 25, 27), (21, 24, 29), (22, 24, 31), (23, 37, 24), (24, 37, 35), (25, 36, 24), (26, 37, 26), (27, 26, 25), (28, 35, 24), (29, 38, 36), (30, 38, 35), (31, 24, 38), (32, 39, 35);
...
VALUES (
        ...
        '2018-12-24',
        '2018-12-25',
        '5c209ba7d3f583.51289913.jpg'
    ), (
        24,
        24,
        'NUST massacre to cancel ESEs',
        '2018-12-24',
        '2018-12-26',
        '5c209c2766ac54.60298371.jpg'
    ), (
        25,
        24,
...
VALUES (
        ...
        21,
        'annual suicide competition',
        'lezz go kill ourselves bois!',
        'time to suicide!'
    ), (
        14,
        22,
        'Flat Earther Convention 2019',
        'They are deceiving us!! Open your eyes!',
        ...
        23,
        'Food Gala',
        'lets get FAT! like Anas Kamal',
        'FOOD IS GOOD FOOD IS LIFE<br> I WANT FOOD I WANT SPICE'
    ), (
        16,
        24,
        'NUST massacre to cancel ESEs',
        'lets kill all the staff and cancel our papers',
        'yay kill everyone like theres no tomorrow'
    ), (
        17,
        25,
        'Annual Welcome Party',
        'welcome to NUST where we all study and do nothing else (seriously)',
        'welcome to nust everyone everyone now go study'
    ), (
        18,
        26,
        'Election Dharna',
        'HAMAREY SAATH DHAANDLI HUI HAI',
        'Ye bik gai hai gormint,<br>\r\nye sarey ham ko pagal bana rahey hain'
    ), (
        19,
        27,
        'Student Council Election',
        'Vote for the new council',
        'pls vote :)'
    );
...
VALUES (2, 15, 24, 30, 'mmm'), (3, 15, 30, 24, 'hello'), (4, 15, 24, 30, 'aaa'), (5, 15, 24, 30, 'hello there'), (6, 15, 24, 30, 'a'), (7, 16, 24, 25, 'hey there buddy'), (8, 16, 24, 25, 'how ya doing?'), (9, 16, 25, 24, 'doing fine bro'), (
        10,
        16,
        25,
        24,
        ...
        25,
        'dasd as das das das'
    ), (12, 16, 25, 24, 'das das das'), (13, 16, 24, 25, 'fuck off'), (14, 16, 25, 24, 'you too ;}'), (15, 16, 25, 24, ':]'), (
        16,
        16,
        24,
        25,
        'dont be aa burden'
    ), (17, 16, 25, 24, ':)'), (18, 16, 25, 24, 'no'), (
        19,
        16,
        25,
        24,
        ...
        24,
        25,
        'yea i make my ownn burden'
    ), (
        21,
        16,
        25,
        24,
        'being bese-8b be like'
    ), (22, 16, 24, 25, 'aa'), (23, 16, 25, 24, 'Hey there!'), (24, 16, 24, 25, 'fuck off'), (25, 16, 25, 24, 'ok, bye'), (
        26,
        16,
        25,
        24,
        'You told me to fuck off, so I\\\'m going now'
    ), (
        27,
        16,
        24,
        ...
        24,
        'aaaaaaaaaaaaaaaa'
    ), (31, 16, 25, 24, 'hhhh'), (32, 16, 25, 24, 'f off raveed'), (
        33,
        16,
        24,
        25,
        'aaaaaaaaaaaaaaa'
    ), (34, 16, 24, 25, 'a'), (35, 16, 24, 25, 'a'), (36, 16, 24, 25, 'a'), (37, 16, 25, 24, 'a'), (38, 16, 25, 24, 'a'), (39, 16, 24, 25, 'sasas'), (
        40,
        16,
        24,
        25,
        ...
        25,
        'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'
    ), (42, 16, 24, 25, 'dsadas dsa'), (43, 16, 24, 25, 'get lost'), (
        44,
        16,
        24,
        25,
        'sdasd dssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss'
    ), (
        45,
        16,
        24,
    ...
    ), (46, 16, 24, 25, 'asdasdasd'), (47, 16, 24, 25, 'asdasdasd'), (48, 16, 24, 25, 'hey'), (49, 22, 24, 31, 'hello?'), (50, 16, 24, 25, 'oye'), (51, 16, 24, 25, 'hello'), (
        52,
        23,
        37,
        24,
        'wassup ma nigga'
    ), (53, 24, 37, 35, 'fuck u'), (54, 24, 37, 35, 'fuck u'), (55, 23, 24, 37, 'fuck you'), (56, 25, 36, 24, 'soora'), (57, 25, 24, 36, 'dalla'), (
        58,
        24,
        35,
        37,
        'Please don\\\'t send offending messages'
    ...
    ), (61, 28, 24, 35, 'hello'), (62, 30, 38, 35, 'hello'), (63, 30, 35, 38, 'heyyy'), (64, 30, 35, 38, 'heyyy'), (65, 30, 35, 38, 'heyyy'), (66, 30, 35, 38, 'heyyy'), (67, 25, 24, 36, 'oye'), (
        68,
        25,
        24,
        36,
        ...
        36,
        'i have something important to tell you'
    ), (70, 31, 24, 38, 'hey'), (71, 31, 24, 38, 'hello?'), (72, 32, 39, 35, 'hello'), (
        73,
        28,
        24,
        35,
        'nah man, im too nervous'
    );
...
VALUES (
        ...
        14,
        'How to kill Linear Algebra',
        '2018-12-05 22:38:43',
        '2018-12-05 22:38:43',
        '1',
        24,
        'linear algebra has caused more deaths then eating pizza with pepsi in the last 69 years',
        0
    ), (
        15,
        'how to eat water',
        ...
        '1',
        24,
        'pls pls help me i dying of hunger i need a cigarette asap ',
        1
    ), (
        17,
        'what to buy on 9/11 festival',
        '2018-12-17 22:49:37',
        '2018-12-17 22:49:37',
        '1',
        24,
        'i want to celebrate 9/11 what do i buy to throw at people',
        1
    );
...
VALUES (6, 12, 7, 24), (8, 12, 10, 25), (11, 12, 10, 27), (13, 14, 20, 27), (14, 14, 20, 25), (19, 15, 26, 24), (20, 14, 22, 24), (21, 12, 10, 36), (22, 15, 27, 37), (23, 15, 27, 35), (24, 14, 18, 38);
...
VALUES (
        ...
        87,
        'im bored tf am i supposed to do?',
        '2018-11-21 16:04:52',
        35,
        25,
        0
        ...
        89,
        ' hj bjhb hj nj b j njn jjnsgjnfj ngjf ngjf ngjfn gdjf ngdjn gfdngjdn gjdfng djf gjdfn gjdjf gjd gjdf ngjdn fgjndjf gjdf ngjd fngjndfjg djf gjdf gjdfjgndjfnd gjdnfgjdfj gdjf gjdf gjdfjg dj gjd gjdjg jd gjdjg ndj gjdfn gjdnfj gndjf ngjd n',
        '2018-11-21 16:06:35',
        31,
        25,
        1
        ...
        100,
        'hello people how are you all doing i hope ure doing well. if so, please kill yourself right now this is a matter of urgency we have to control the world population. this is a great cause and its an honor for all of u that u will die for such a great cause <br>',
        '2018-12-16 12:09:28',
        31,
        24,
        2
        ...
        101,
        'i have a serious butthurt somebody pls help ;_;',
        '2018-12-16 21:59:22',
        36,
        24,
        1
        ...
        109,
        'Im stuck at database project. Need help ! Cant create a schema in SQL.',
        '2018-12-24 11:57:29',
        42,
        36,
        -2
        ...
        110,
        'Can anyone please tell me how to debug my C++ code?',
        '2018-12-24 12:04:30',
        43,
        35,
        -2
        ...
        112,
        'Have you tried downloading some more RAM?',
        '2018-12-24 12:07:33',
        43,
        37,
        1
        ...
        113,
        'What do libraries do? Allow you to read books in your code? Or embed books in your code?',
        '2018-12-24 12:11:09',
        44,
        35,
        -2
        ...
        116,
        '\"It\'s okay if you\'re not made for coding\" - Sir Faisal Shafait',
        '2018-12-24 12:43:48',
        43,
        36,
        0
        ...
        120,
        'we need to summon the magic cat to answer this question',
        '2018-12-27 18:01:51',
        42,
        24,
        0
...
VALUES (1, 89, 24, '2018-12-15', 1), (2, 82, 24, '2018-12-17', 1), (3, 100, 24, '2018-12-16', 1), (4, 82, 25, '2018-12-16', -1), (5, 100, 25, '2018-12-16', 1), (6, 94, 25, '2018-12-16', 1), (7, 101, 24, '2018-12-20', 1), (8, 104, 37, '2018-12-24', 1), (9, 110, 24, '2018-12-24', -1), (10, 109, 37, '2018-12-24', -1), (11, 110, 37, '2018-12-24', -1), (12, 113, 37, '2018-12-24', -1), (13, 114, 37, '2018-12-24', 1), (14, 114, 35, '2018-12-24', 1), (15, 112, 24, '2018-12-24', 1), (16, 82, 36, '2018-12-24', 1), (17, 115, 24, '2018-12-27', 1), (18, 113, 36, '2018-12-24', -1), (19, 115, 36, '2018-12-24', 1), (20, 113, 38, '2018-12-24', 1), (21, 113, 24, '2018-12-25', -1), (22, 114, 24, '2018-12-25', 1), (23, 118, 24, '2018-12-27', 1), (24, 119, 24, '2018-12-27', 1), (25, 117, 24, '2018-12-27', 1), (26, 109, 24, '2018-12-27', -1), (27, 121, 24, '2018-12-28', 1), (28, 83, 24, '2018-12-31', 1), (29, 84, 24, '2018-12-31', 1), (30, 85, 24, '2018-12-31', 1), (31, 95, 24, '2018-12-31', 1), (32, 108, 24, '2018-12-31', 1), (33, 122, 24, '2018-12-31', 1);
...
CREATE TRIGGER `CALC_FORUM_VOTES_AFTER_DELETE` AFTER 
DELETE ON `POSTVOTES` FOR EACH ROW BEGIN 
	update posts
	set
	    posts.post_votes = posts.post_votes - old.vote
	where
	    posts.post_id = old.votePost;
	END 
$ 
...
CREATE TRIGGER `CALC_FORUM_VOTES_AFTER_INSERT` AFTER 
INSERT ON `POSTVOTES` FOR EACH ROW BEGIN 
	update posts
	set
	    posts.post_votes = posts.post_votes + new.vote
	where
	    posts.post_id = new.votePost;
	END 
$ 
...
CREATE TRIGGER `CALC_FORUM_VOTES_AFTER_UPDATE` AFTER 
UPDATE ON `POSTVOTES` FOR EACH ROW BEGIN 
	update posts
	set
	    posts.post_votes = posts.post_votes + (new.vote * 2)
	where
	    posts.post_id = new.votePost;
	END 
$ 
...
VALUES (
        1,
        'owaisrehman110@gmail.com',
        '73abf7a3e5e48bce',
        '$2y$10$9ytyvfXk8gb8gRzVfRglwevJBy6o46WDrp2ncNj58Y8sjWM4iNSTi',
        '1543912151'
    ), (
        2,
        '',
        '459ea1feb0d537ee',
        '$2y$10$jlC8JTnnikaZ7.4g4UMIHeIlqgJfe3iA4OFlruh5OQNtWVf1FfZqi',
        '1545078648'
    ), (
        4,
        'asd@as.asd',
        'fb72aeade725bc83',
        '$2y$10$HTEtmrlaWZpcspmoFAa90Owrd5V4UDorSyWapnRzGOjqxFkHKTexC',
        '1545079924'
    ), (
        5,
        'a@a.a',
        '4c5a0e6dcd3aa696',
        '$2y$10$R6lxGNFwcrf0t3/onGFqseQNxzrYzsimBUU23k7XKUONE3rUZaTrm',
        '1545079978'
    ), (
        11,
        'muhammadsaad.crytek@gmail.com',
        '34219d525a406a67',
        '$2y$10$TK.dVQ7B3Ulq95R.dCUdY.YLYAPOJBX8HDUiJW4CmEutkqg63BFQi',
        '1545915863'
    ), (
        12,
        'pureliquid1999@gmail.com',
        '74e3d2f2db2cb3e3',
        '$2y$10$uB4kDEYHvlLk13irN3A/dOL7t6h.i6GKW8eXKZ3v2azUnlABXl.NW',
        '1545915911'
    ), (
        13,
        'ms.merium.fatima@gmail.com',
        '62564c5e753b0ad3',
        '$2y$10$xBW5MsGZMevV8her23zBz.2qsJrWuLgtb.ThBiyUssPsy9tioShmi',
        '1546003625'
    );
...
VALUES (
        ...
        'sadcat',
        'a@a.a',
        '$2y$10$RiiU91TqjjVhPdVpypQBtuq0etClplrZ3HNTLPFrUheJ.sy7ZifwK',
        'f',
        '',
        '',
        '5bf28f767563d4.32287587.jpg'
    ), (
        26,
        0,
        '',
        ...
        'crazyblogger',
        'aaa@gmail.com',
        '$2y$10$zXwVteLyKxjwSMDk.a8/HeoYzmfFInzvftURiCyt27z03mgbdkSNy',
        'm',
        '',
        '',
        '5c2097e915f3e7.13501262.jpg'
    ), (
        27,
        0,
        '',
        ...
        'vegetapoopoo',
        'asd@asd.asd',
        '$2y$10$S4X2HZUWyQXV7zLwirj2dOBVEbDHFDhsX6y91asglNa6QBnlq9ik.',
        'f',
        '',
        '',
        '5bf2ebf077fb14.69408796.gif'
    ), (
        29,
        0,
        '',
        '',
        'yhamster',
        'anas.tasadduq@gmail.com',
        '$2y$10$j5scT2dgJuZGBBYBFRsKVe.n50dLCjdYvcpY1Vy1.jES8f6ojulAi',
        'm',
        '',
        '',
        '5c03ad0de59709.45156405.jpg'
    ), (
        30,
        0,
        '',
        ...
        'Owais',
        'owaisrehman110@gmail.com',
        '$2y$10$EM.p1ed./gfrenQRn5Je1etujHptdTebKy8fgDU0de1wGqQvOOCcK',
        'm',
        '',
        '',
        'default.png'
        ...
        'constipated',
        'was@was.was',
        '$2y$10$BnAjjEdfYa0koUab7jB2wuK/Hw5PEoRHMsIjuPOgFDK3umLLPnE2a',
        'm',
        '',
        ...
        'progamer',
        'qq@qq.qq',
        '$2y$10$9RwEOoQi4i7BHcVuN9sihOQ156yAqPOi1/cGayAc83glZMUJ8B702',
        'f',
        'what to do with myself',
        'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
        '5c1b521a779e33.90465765.jpg'
    ), (
        33,
        0,
        'soSaad',
        ...
        'sad',
        'sad@sad.sad',
        '$2y$10$MgXJs2KXFHDywcokNF.Ya.FubCPFkCV5WhvpzyDw7KioB.hImzjpS',
        'm',
        '',
        '',
        '5c1e837c23fbd4.49025477.jpg'
    ), (
        34,
        0,
        'aass',
        ...
        'designer',
        'sss@sss.sss',
        '$2y$10$a/DczAbcWogc9E.QVtQ27uaIaQKIY.qi.d7OSyOI/XHT.g.DCF0XG',
        'f',
        'hallo hallo',
        'pls go die, seriously',
        '5c20049a28f083.62453939.jpg'
    ), (
        35,
        0,
        'Anas',
        'Tasadduq',
        'aitasadduq',
        'atasadduq.bese17seecs@seecs.edu.pk',
        '$2y$10$mE..r1B9evnZeZ03CRmChO6hOCzWyzSOiciIjvYynq4atCtWBZtfy',
        'm',
        'I\'m great!',
        'I don\'t really want to tell much about myself...',
        '5c207f31c827d2.61541321.jpg'
    ), (
        36,
        0,
        'Ubaid',
        'Asim',
        'UbaidAsim',
        'ubaidasim514@gmail.com',
        '$2y$10$mJY/nezYA6PXFy0t.xXMyuVQOAdLi5I/ag.SWwUVFvHkZGcfqwd3S',
        'm',
        'Freelance Graphics and Brand Designer, Social Media Strategist',
        'Software Engineering Student at SEECS, NUST',
        '5c207f7341e066.29286370.jpg'
    ), (
        37,
        0,
        'Syed',
        'Kamal',
        'syedanaskamal',
        'syedanaskamal@gmail.com',
        '$2y$10$.fUUvM3BoaCPV9Blp8CobONwQpI1r6kSUnts.QTm3a9Yovo5le.N6',
        'm',
        'wassup',
        'no',
        'default.png'
        ...
        'testuser',
        'testuser@test.com',
        '$2y$10$80YI6fiwFyOLHhn4CIOG/.xSAmkvG1L12LHGXjlNMdjwxeQCx/GNy',
        'm',
        '',
        '',
        '5c20b68db30f81.29224418.jpg'
    ), (
        39,
        0,
        '',
        ...
        'marium',
        'ms.merium.fatima@gmail.com',
        '$2y$10$l0AOTRif1CfL7pONxdOxHuyg4worYd4yagtUcom9u/LPeQs6n4ZN2',
        'f',
        '',
        '',
        'default.png'
...
ALTER TABLE
    `blogs` MODIFY `blog_id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 20;
...
ALTER TABLE
    `blogvotes` MODIFY `voteId` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 24;
...
ALTER TABLE
    `categories` MODIFY `cat_id` int(8) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 14;
...
ALTER TABLE
    `conversation` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 33;
...
ALTER TABLE
    `events` MODIFY `event_id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 28;
...
ALTER TABLE
    `event_info` MODIFY `event_id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 20;
...
ALTER TABLE
    `messages` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 74;
...
ALTER TABLE
    `polls` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 18;
...
ALTER TABLE
    `poll_options` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 36;
...
ALTER TABLE
    `poll_votes` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 25;
...
ALTER TABLE
    `posts` MODIFY `post_id` int(8) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 123;
...
ALTER TABLE
    `postvotes` MODIFY `voteId` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 34;
...
ALTER TABLE
    `pwdreset` MODIFY `pwdResetId` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 14;
...
ALTER TABLE
    `topics` MODIFY `topic_id` int(8) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 45;
...
ALTER TABLE
    `users` MODIFY `idUsers` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 40;
