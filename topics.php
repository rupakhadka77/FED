    ...
    <main role="main" class="container" style=" margin-top:100px;">
        ...
        <div class="my-3 p-3 bg-white rounded shadow-sm">
            ...
            <h5 class="border-bottom border-gray pb-2 mb-0">
                ...
                { $interestUser = ucwords($category["cat_name"]);
                }
                 else
                 {
                ...
                <a
                    href='insert_interest.php?user_interest=<?php echo    $resStr2 = str_ireplace(' ', '_', $interestUser)?>&cat_id=<?php echo    $_GET['cat']?> '>
                    <button
                        style="padding: 0.7rem; border-radius:0.4rem;color:white;background-color:cornflowerblue;cursor:pointer;margin-left:890px;">Join</button></a>
            </h5>
