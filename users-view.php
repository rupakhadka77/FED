...
<body>
                                  ...
                                  <div class="media text-muted pt-3">
                                      ...
                                      <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray ">
                                        <strong class="d-block text-gray-dark">'.ucwords($row['uidUsers']).'</strong></a>
                                            <span class="text-info">'.ucwords($row['f_name'].' '.$row['l_name']).'</span><br>
                                            '.$row['emailUsers'].'
                                      </p>
                                      <span class="text-right text-warning">
                                          <a href="chat.php?user_id='.$row['idUsers'].'" >
 ...
 ?>
                ...
                <small class="d-block text-right mt-3">
                    <a href="profile.php" class="btn btn-info">Go to Profile</a>
                    <a href="users.php" class="btn btn-warning">Go to Inbox</a>
                </small>
